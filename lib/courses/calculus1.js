export const courseCode = "MAT 116";
export const color = "#10b981";
export const textbook_name = "Early Transcendentals";
export const textbook_author = "James Stewart";
export const textbook_edition = "9";
...
export { buildPrompt, buildGeneratePromptRules, buildMutationRules, buildSectionRules, sectionTopicConstraints, crossSectionRule, crossSectionRuleShort, questionTypes } from "./_calcPrompt.js";
