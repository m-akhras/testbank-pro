export const courseCode = "MAT 110";
export const color = "#e879f9";
export const textbook_name = "";
export const textbook_author = "";
export const textbook_edition = "";
...
- Shared stem (e.g. "Let f(x) = 2x^2 - 5x + 3") followed by 2-4 multiple-choice parts.
...
- All parts reference the SAME stem (same function / same triangle / same equation).
- Distractors per part: same-question distractors only — never put answers to a different part in the choice list. Distractors should reflect typical sign / factoring / unit-conversion mistakes for the topic.
- The 4 parts must each test a DIFFERENT skill (e.g. find x-intercepts, find vertex, find axis of symmetry, evaluate at given x) — do not repeat the same operation four times.
