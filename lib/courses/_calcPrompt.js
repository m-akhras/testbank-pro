...
Each segment may have:
  ...
  - label: { text, at, offsetX, offsetY, align } — same shape as region
    boundary labels; supports x^2 superscripts, _1 subscripts, Greek
    names, sqrt → √.
...
The label is rendered with a white halo so it stays readable over hatch
or curves.
