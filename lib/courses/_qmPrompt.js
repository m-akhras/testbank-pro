...
10. CHAPTER 8 (Interval Estimation) — t-distribution lookup rule:
...
11. EXPECTED VALUE & VARIANCE — required question-type variety. These are ADDITIONS to the existing probability/calculation pool, not replacements. Across any generated set, mix probability questions with E(X) / Var(X) / SD(X) questions so students see both.
