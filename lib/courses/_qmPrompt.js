...
9. SECTION 14.1 ONLY (Simple Linear Regression Model) — strict word-problem rules. NON-NEGOTIABLE:
   ...
   A. NAMED VARIABLES, NEVER x / y / ŷ.
      The single-letter variables "x", "y", and "ŷ" (or "yhat") MUST NOT appear anywhere in the question text, regression equation, answer choices, or explanation. Use the named scenario variables on BOTH sides of every equation.
      WRONG: "Given y = 14 + 2.2x, predict y when x = 5."
      WRONG: "Production cost follows y = 100 + 5x. What is cost at x=10?"
      WRONG: "ŷ = 100 + 5x" (still uses x and ŷ).
      RIGHT: "The estimated regression line is Sales = 100 + 5 · Advertising. Predict Sales when Advertising spend is $10,000."
      RIGHT: "From the scatter plot of Hours Studied vs Test Score, the fitted equation is Score = 52 + 4.5 · Hours."

   B. EQUATION FORM.
      Always write the regression equation as: <Response> = b₀ + b₁ · <Predictor>
      with the named variables and the actual numeric coefficients substituted in.
   ...
   D. ALLOWED QUESTION TYPES — generate a mix across the set, never all the same type:
      ...
      c. Find b₀ and b₁ from a scatter plot or a summary table (Σx, Σy, Σxy, Σx², n).
         ...
         All four choices are equations IN NAMED-VARIABLE FORM, e.g. "Sales = 100 + 5 · Advertising".
      ...
      d. Identify the full regression equation from a graph.
         ...
         All four choices use the named-variable form.
   ...
   E. ANSWER CHOICE STYLE — strict per type:
      ...
      - Types c, d (equation identification): all four choices are equations in named-variable form. No "y =" choices.
   ...
   F. FORBIDDEN in 14.1 — these belong in later sections, do NOT generate them here:
      ...
      - The bare symbols "x", "y", or "ŷ" anywhere in question text, equation, choices, or explanation.
${mathNotationBase}
${commonRules}`;
}
