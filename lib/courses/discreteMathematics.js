export const courseCode = "MAT 230";
...
- 9.1, 9.8, 9.9: For probability questions involving two events, set hasGraph:true and emit graphConfig using the same "venn" shape as 6.1–6.3 (sets, shaded, elementsA/B/AB, universeLabel).
