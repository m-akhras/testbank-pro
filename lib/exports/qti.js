...
import { stripChoiceLabel, isGraphChoice, _findCorrectChoiceIdx, answerMatchesAChoice } from "../utils/questions.js";
...
// The answer-∈-choices matcher now lives in lib/utils/questions.js so the
// static validator (validateQuestion) and the QTI export gate share ONE
// implementation (see docs/exam_pipeline_design.md §4). It's imported above for
// local use by the builders/guard, and re-exported here so existing importers —
// lib/exports/index.js, hooks/useGenerate.js, and tests/qti.test.js — keep their
// byte-identical import paths.
export { _findCorrectChoiceIdx, answerMatchesAChoice };
