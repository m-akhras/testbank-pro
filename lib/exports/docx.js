...
<w:ftr xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  <w:p>
    <w:pPr>
      ...
      <w:tabs><w:tab w:val="right" w:pos="11088"/></w:tabs>
...
export async function buildDocx(questions, course, vLabel, classSection=null, startNum=1, templateConfig=null) {
  ...
  function para(text, opts={}) {
    ...
    if (rightText) {
      ...
      const ppr = `<w:pPr><w:tabs><w:tab w:val="right" w:pos="11088"/></w:tabs><w:spacing w:after="${spacing}"/>${indent?`<w:ind w:left="${indent}"/>`:''}</w:pPr>`;
  ...
  function buildQuestionHeader(num, text, marks) {
    ...
    const ppr = `<w:pPr><w:tabs><w:tab w:val="right" w:pos="11088"/></w:tabs><w:spacing w:after="120"/></w:pPr>`;
