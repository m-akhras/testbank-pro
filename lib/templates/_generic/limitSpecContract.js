...
nonexistent / undefined result as "does not exist (DNE)".

For Multiple Choice §2.2 questions: still author 4 plausible choices. The system
formats the DERIVED value and matches it to one of your choices. If the derived
truth is not among your choices, the question is REJECTED — so make sure the
correct value is present verbatim (e.g. include "4", "does not exist (DNE)",
