...
your choices are discarded. The reasons test understanding (e.g. the removable-hole trap
"the limit equals f(a)", the jump misconception "DNE because f(a) differs"), so a
reason/justification question is now a normal MULTIPLE CHOICE here.
`;
