...
- Multiple Choice: the SYSTEM composes BOTH the correct answer AND all distractors from the derived values — your choices are placeholders. Still emit exactly 4 short placeholder choices (e.g. "A", "B", "C", "D") for schema validity; the system OVERWRITES all of them with correct-and-wrong options in one uniform compound format, e.g.: "the limit of (f + g) as x approaches 3 = 4; the limit of f/g as x approaches 1 = does not exist (DNE); the limit of (x^2)*f as x approaches 2 = 8". You CANNOT set or word the answer — do not try.
