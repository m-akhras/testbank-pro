...
MULTIPLE CHOICE: plain VALUE asks ONLY — choices are BARE SCALARS (a number, or "does
not exist (DNE)"); the system derives the correct value and injects it. A
reason/justification question must be FREE RESPONSE (the derived explanation is authoritative).
`;
