...
// THE single shared scalar formatter for the whole limit engine. §2.2/§2.5
// (applyLimitSpec.formatValue) bridge their raw deriveLimits encoding through
// toLimitValue and call this; §2.3 (applyLimitLaws) calls it on combined results.
// Numbers verbatim, ±∞ as "infinity"/"-infinity", DNE as "does not exist (DNE)".
