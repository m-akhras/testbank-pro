...
import SinglePiecewiseChoice   from "./SinglePiecewiseChoice.jsx";
...
export default function GraphChoice({ config, width, height, style }) {
  ...
  switch (t) {
    ...
    case "single":      return <SinglePiecewiseChoice config={config} width={width} height={height} style={style} />;
    case "piecewise":   return <SinglePiecewiseChoice config={config} width={width} height={height} style={style} />;
    default:
      return (
